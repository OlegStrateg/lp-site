...
export const CONVERT_HUB_LOCALES: ConvertHubLocale[] = [
  {
    ...
    copy: {
      ...
      popularLabel: '01 · Popular converters', popularHeading: 'The main conversion jobs, shown the way they actually work.', popularIntro: 'Real product imagery where it explains the task. Purpose-built format graphics everywhere else.',
      ...
      designLabel: '02 · Image & design converters', designHeading: 'Four PSD routes. One consistent visual system.', designIntro: 'File layers and output states explain these conversions more clearly than unrelated photography.',
  ...
  },
  {
    ...
    copy: {
      ...
      popularLabel: '01 · Популярные конвертеры', popularHeading: 'Основные задачи конвертации — показаны так, как они реально работают.', popularIntro: 'Реальные изображения продукта там, где они помогают понять задачу. В остальных местах — понятная графика форматов.',
      ...
      designLabel: '02 · Конвертеры изображений и дизайна', designHeading: 'Четыре направления PSD. Единая визуальная система.', designIntro: 'Слои файла и итоговый формат объясняют эти преобразования лучше, чем случайные фотографии.',
  ...
  },
  {
    ...
    copy: {
      ...
      popularLabel: '01 · Beliebte Konverter', popularHeading: 'Die wichtigsten Konvertierungen so dargestellt, wie sie wirklich funktionieren.', popularIntro: 'Echte Produktbilder, wenn sie die Aufgabe erklären. Ansonsten klare Formatgrafiken.',
      ...
      designLabel: '02 · Bild- & Design-Konverter', designHeading: 'Vier PSD-Wege. Ein einheitliches visuelles System.', designIntro: 'Dateiebenen und Ausgabezustände erklären diese Konvertierungen besser als unpassende Fotos.',
  ...
  },
  {
    ...
    copy: {
      ...
      popularLabel: '01 · Convertidores populares', popularHeading: 'Las conversiones principales, mostradas tal como funcionan.', popularIntro: 'Imágenes reales del producto cuando ayudan a entender la tarea. Gráficos de formato claros en los demás casos.',
      ...
      designLabel: '02 · Convertidores de imagen y diseño', designHeading: 'Cuatro rutas PSD. Un sistema visual coherente.', designIntro: 'Las capas del archivo y el formato de salida explican estas conversiones mejor que fotografías sin relación.',
  ...
  },
  {
    ...
    copy: {
      ...
      popularLabel: '01 · Convertisseurs populaires', popularHeading: 'Les principales conversions, présentées comme elles fonctionnent réellement.', popularIntro: 'Des visuels produit réels lorsqu’ils expliquent la tâche. Des graphiques de format dédiés dans les autres cas.',
      ...
      designLabel: '02 · Convertisseurs image & design', designHeading: 'Quatre parcours PSD. Un seul système visuel.', designIntro: 'Les calques et les formats de sortie expliquent mieux ces conversions que des photos sans rapport.',
  ...
  },
  {
    ...
    copy: {
      ...
      popularLabel: '01 · Conversores populares', popularHeading: 'As principais conversões, mostradas como realmente funcionam.', popularIntro: 'Imagens reais do produto quando ajudam a explicar a tarefa. Gráficos de formato dedicados nos demais casos.',
      ...
      designLabel: '02 · Conversores de imagem e design', designHeading: 'Quatro rotas PSD. Um sistema visual consistente.', designIntro: 'Camadas de arquivo e formatos de saída explicam essas conversões melhor do que fotos sem relação com a tarefa.',
  ...
  },
  {
    ...
    copy: {
      ...
      popularLabel: '01 · よく使う変換ツール', popularHeading: '主要な変換処理を、実際の作業がわかる形で表示。', popularIntro: '作業内容の理解に役立つ場所では実際の製品画像を使い、それ以外は形式がわかる専用グラフィックで表現します。',
      ...
      designLabel: '02 · 画像・デザイン変換', designHeading: '4つのPSDルートを、統一した見た目で。', designIntro: '無関係な写真ではなく、ファイルのレイヤーと出力形式で変換内容をわかりやすく示します。',
  ...
  },
  {
    ...
    copy: {
      ...
      popularLabel: '01 · 常用转换器', popularHeading: '主要转换任务，用实际工作方式展示。', popularIntro: '能帮助理解任务时使用真实产品图片，其余位置使用专门设计的格式图形。',
      ...
      designLabel: '02 · 图片与设计转换器', designHeading: '四种 PSD 转换路径，一套一致的视觉系统。', designIntro: '文件图层和输出状态比无关照片更能清楚说明这些转换。',
