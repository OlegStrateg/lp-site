...
## LP-039 — непрерывность утверждённой SEO-семантики

Для Home действует обязательное правило:

1. Утверждённый SEO-root, используемый в `title`, должен иметь точное естественное вхождение в `meta description` и в видимый полный текст страницы.
2. Значимые SEO-фразы, использованные в `meta description`, должны иметь точные естественные вхождения в видимый полный текст страницы.
3. Утверждённое написание ключа считается частью семантики. Нельзя без доказательств менять:
   - дефис;
   - пробел;
   - предлог;
   - порядок слов;
   - морфологическую форму;
   - локальную/английскую форму.
4. Если возникает гипотеза использовать другой вариант написания, сначала проверяются сохранённые ASO/SEO-данные, SERP/Suggest/Semrush и реальное употребление. Если подтверждения нет — используется зафиксированная форма.
5. Редакторская вычитка не имеет права «улучшать» утверждённый keyword ценой потери точного вхождения.
6. Title не меняется автоматически ради согласования. Сначала сохраняется утверждённый title, а description/body приводятся к его зафиксированной семантике.
7. Правило относится к SEO-фразам, а не к каждому служебному слову текста: задача — непрерывность продвигаемой семантики без keyword stuffing.
